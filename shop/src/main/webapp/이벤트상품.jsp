...
<head>
    ...
    <link rel="apple-touch-icon" href="assets/웹사이트 img/apple-icon.png">
    <link rel="shortcut icon" type="image/x-icon" href="assets/웹사이트 img/favicon.ico">
                            ...
                            <div class="card rounded-0">
                                ...
                                <div class="card-img-overlay rounded-0 product-overlay d-flex align-items-center justify-content-center">
                                    <ul class="list-unstyled">
                                        <li><a class="btn btn-success text-white mt-2" href="선물포장 씰스티커.html"><i class="far fa-eye"></i></a></li>
                                    </ul>
                                </div>
                            </div>
                            <div class="card-body">
                                <a href="shop-single.html" class="h3 text-decoration-none">3월신상 올인원팩</a>
